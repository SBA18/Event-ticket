...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12">
            <h3 class="text-muted"><i class="fas fa-ticket-alt"></i>  Tickets for {{ Auth::user()->name}}</h3>
            <hr class="text-muted">
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <td><a href="{{ route('event_show', $ticket->event->uuid)}}">{{ str_limit($ticket->event->name, 20)}}</a></td>
                    ...
                    @endif
                    @if($ticket->status != 1)
                    <td class="text-right" style="width: 100px;"><a class="btn btn-danger" href=""><i class="fas fa-ban"></i>  Cancel</a></td>
                    @endif
                    </tr>
                    @endforeach
                </tbody>
